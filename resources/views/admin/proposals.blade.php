    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                ...
                <div class="text-muted mt-1">1-18 of 413 proposal</div>
            </div>
            <!-- Page title actions -->
            <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                    <input type="search" class="form-control d-inline-block w-9 me-3" placeholder="Search user…" />
                    <a href="{{ route('proposals-create') }}" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-create-proposal"  >
...
<div class="modal modal-blur fade" id="modal-create-proposal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Proposal / Cover Letter</h5>
