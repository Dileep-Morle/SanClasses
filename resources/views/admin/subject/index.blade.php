            ...
            <div class="col-12">
                <div class="card">
                                    ...
                                    <td>
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                <a class="dropdown-item" href="{{route('subject-edit', $subject->id)}}">
                                                    Edit
                                                </a>
                                                <a class="dropdown-item" href="{{route('subject-destroy', $subject->id)}}">
                                                    Delete
                                                </a>
                    ...
                    <div class="card-footer d-flex align-items-center">
                        ...
                        <p class="m-0 text-muted">Showing <span>{{ $addsubject->firstItem() }}</span> to <span>{{ $addsubject->lastItem() }}</span> of <span>{{ $addsubject->total() }}</span> entries</p>
