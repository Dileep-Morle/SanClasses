            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                @foreach ($addplan as $plan)
                                <tr>
                                    <td>{{$plan->id}}</td>
                                    <td>{{$plan->name}}</td>
                                    <td>{{$plan->price}}</td>
                                    <td>{{$plan->validity.' '.'Days'}}</td>
                                    <td>{{strip_tags($plan->descreption)}}</td>
                                    ...
                                    <td>
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                ...
                                                <a class="dropdown-item" href="{{route('plan-destroy', $plan->id)}}">
                                                    Delete
                                                </a>
                    ...
                    <div class="card-footer d-flex align-items-center">
                        ...
                        <p class="m-0 text-muted">Showing <span>{{ $addplan->firstItem() }}</span> to <span>{{ $addplan->lastItem() }}</span> of <span>{{ $addplan->total() }}</span> entries</p>
