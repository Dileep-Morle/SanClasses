    ...
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href="{{ route('dashboard') }}">
                <img src="/admin/static/sansclasess.png" width="110" height="32" alt="Tabler" class="navbar-brand-image" />
            </a>SANCLASSES
        </h1>
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="nav-item dropdown d-none d-md-flex me-3">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-card">
                    <div class="card">
                        <div class="card-body">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus ad amet consectetur exercitationem fugiat in ipsa ipsum, natus odio quidem quod repudiandae sapiente. Amet debitis et magni maxime
            ...
            <ul class="navbar-nav pt-lg-3">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                <a class="dropdown-item" href="{{ route('blog-tag') }}">
                                    Blog Tags
                                </a>
                                <a class="dropdown-item" href="{{ route('blog-categories') }}">
                                    Blog Categories
                                </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('vocabulary') }}">
                          Vocabularys
                        </a>                        
                ...
                <a class="nav-link dropdown-toggle" href="#navbar-extra" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('testmonial') }}">
                                    Testmonials
                                </a>
                            </div>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item" href="{{ route('plan') }}">
                                    Plans
                                </a>
                                <a class="dropdown-item" href="{{ route('teaching-plan') }}">
                                    Teaching Plans
                                </a>
                            </div>
                        </div>
