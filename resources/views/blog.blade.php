          ...
          <div class="col-lg-8">
            <div class="row">
              <div class="col-xl-12 mx-auto">
                <h1 class="display-1 mb-4">Business News</h1>
                <p class="lead fs-lg mb-4">Welcome to our journal. Here you can find the latest company news and business articles.</p>
              </div>
              <!-- /column -->
            </div>
